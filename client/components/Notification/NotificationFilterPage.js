...
class NotificationFilterPage extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const notifications = [...this.props.notifications.getNotifications].filter((note) => note.type.toLowerCase() === this.props.page);
    return (
      <Layout isAuth>
        <Column style={{ backgroundColor: '#fafafa', height: '98vh', maxHeight: '98vh', overflowY: 'scroll' }}>
          <Column size="is9" style={{ margin: 'auto', position: 'relative' }}>
            <div style={{ display: 'flex' }}>
              <Leftbar active={this.props.page} />
              <div style={{ width: 600, margin: 'auto' }}>
                <div className="answer-section-draft-info">
                  <div className="answer-section-draft-info-header"><span>{_.upperFirst(this.props.page)}{this.props.page !== 'people' && 's'}</span></div>
